...
const Footer = () => {
  ...
  return (
    <footer 
      className={`py-12 ${
        theme === "cyberpunk" ? "bg-cyber-dark border-t border-cyber-purple/20" : "bg-muted/30 border-t"
      }`}
    >
      <div className="container px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="space-y-4">
            ...
            >
              A technical community for GeeksforGeeks enthusiasts at Lovely Professional University.
            </p>
          ...
          <div className="space-y-4">
            <h3 
              className={`text-sm font-bold uppercase ${
                theme === "cyberpunk" ? "text-cyber-pink" : "text-primary"
              }`}
            >
              Quick Links
            </h3>
